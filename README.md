...
Domain
Oni Features Utilized



Systems Programming
Manual memory, OASM, hardware access


Mobile Development
Kotlin/Swift backends


Scientific Computing
GPU math, tensors, Julia syntax


Web Services
WASM, async pipelines


Embedded Systems
Nim backend, low footprint


Cloud Native Apps
Actor model, Kubernetes compatibility
...
Reactive Apps
Actor parallelism, hot reloading
...
Last Updated: May 27, 2025Status: Active Development
